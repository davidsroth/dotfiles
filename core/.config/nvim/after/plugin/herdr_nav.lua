...
-- Vendored from vim-herdr-navigation (MIT):
-- https://github.com/paulbkim-dev/vim-herdr-navigation (editor/nvim.lua)
--
-- Moves between Neovim splits; at a split edge, hands off to herdr so focus
-- crosses into the neighbouring herdr pane. Falls back to tmux (if $TMUX) or
-- plain wincmd outside herdr. Lives in after/plugin so it wins over any other
-- <C-h/j/k/l> mapping (e.g. LazyVim's window-motion defaults).
